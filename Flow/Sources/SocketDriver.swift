...
//    }
//
//    public func run(handler: (NSData) -> NSData) {
//        open()
//        readRequest() { requestData in
//            let responseData = handler(requestData)
//            self.writeResponse(responseData, completion: self.close)
//        }
//    }
//
